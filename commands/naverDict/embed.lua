...
-- {
-- 	name = "위키피디아에 검색하기";
-- 	value = "*[위키피디아로 이동합니다](https://ko.wikipedia.org/wiki/%s)*";
-- 	inline = true
-- }


-- {
-- 	content = "네이버 어학사전 검색 결과입니다";
-- 	embed = {
-- 		title = "%s"
-- 		url = "https://dict.naver.com/search.dict?dicQuery=%s";
-- 		description "%s";
-- 		color = 65230;
-- 		footer = {
-- 			icon_url = "https://ssl.pstatic.net/dicimg/favicons/dict/v1/home/favicon.ico";
-- 			text = "Powered by naver dict / ㅋㅂㄹㅂ 개발"
-- 		};
-- 		fields = {
-- 		};
-- 	};
